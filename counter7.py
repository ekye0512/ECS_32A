...
class Count:
        ...
        def __init__(self):
                ...
                for line in infile:
                        # strip every line in file
                        line=line.strip()
                        #add every line from file into list
        ...
        def get_num_words(self):
                ...
                # get the len/ number of keys in the dict
        ...
        def increment_count(self,word):
                ...
                # We strip any punctuation from our word
                word = word.strip(string.punctuation)
                # we make all the words into lowercase
                word=word.lower()

                # if the word is in the stop words list, we return 
                if word in self.stop_words:
                        return

                # We check if word is in dict, if it is we increment by 1

                

                # if the word is just an empty string, we return to fuction
                ...
                # if word not in dict we create new key and set its value to 1
        ...
        def lookup_count(self,word):
                # create count variable and make it 0

                count=0
                # if word in dict we set the count to its value
                if word in self.word_counts:
        ...
        def get_top_words(self,num):
                ...
                # assign a pair of tuples to list
                return_list=list(self.word_counts.items())
                
                # set each string variable to its corresponding part
                word=return_list[0]
                count=return_list[1]
                ...
                for word, price in self.word_counts.items():
                        L.append((price, word))

                # we loop until the num that's inputted
                for i in range(num):
                ...
                # return the list until the num that the user inputted
                return L[0:num]
       ...
       # print(counter.lookup_count("well"))
        ...
        for line in infile:
                ...
                for word in line:
                        ...
                        # use our function to increment and count every word
