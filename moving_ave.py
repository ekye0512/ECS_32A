...
# Eric Kye
#
# Get the averages from the window centered at a year, we take the start of the file plus the input and the end of the file minus to input to get the range of values
